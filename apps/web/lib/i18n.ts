...
const UI = {
  ...
  imla: { tr: 'İmlâ', en: 'Script' },
  imlaTurkiye: { tr: 'Türkiye', en: 'Türkiye (imlāʾī)' },
  imlaMedine: { tr: 'Medine', en: 'Madinah (Uthmani)' },
  ...
  // Marka + ana sayfa + altbilgi (EN domain: social-quran.com)
  brand: { tr: 'Sosyal Kur’an', en: 'Social Quran' },
  heroLearnTitle: { tr: 'Kur’an okumayı öğren', en: 'Learn to read the Quran' },
  heroLearnSub: { tr: 'Elifbadan tecvide {n} ders — her harf ve örnek sesli', en: 'From alphabet to tajweed, {n} lessons — every letter and example with audio' },
  heroStart: { tr: 'Başla →', en: 'Start →' },
  heroDone: { tr: 'Tamamlandı 🌟', en: 'Completed 🌟' },
  heroContinue: { tr: 'Devam →', en: 'Continue →' },
  continueFrom: { tr: '📖 Kaldığın yerden devam et:', en: '📖 Continue where you left off:' },
  planWidgetPages: { tr: 'sayfa', en: 'pages' },
  planWidgetDays: { tr: 'gün', en: 'days' },
  planWidgetKhatm: { tr: 'Hatim', en: 'Khatm' },
  today: { tr: 'Bugün', en: 'Today' },
  mekki: { tr: 'Mekkî', en: 'Meccan' },
  medeni: { tr: 'Medenî', en: 'Medinan' },
  loginFailed: { tr: '⚠️ Giriş tamamlanamadı', en: '⚠️ Sign-in could not be completed' },
  errState: { tr: 'oturum doğrulaması eşleşmedi', en: 'session verification mismatch' },
  errToken: { tr: 'kimlik sunucusuna ulaşılamadı', en: 'could not reach the identity server' },
  errKimlik: { tr: 'kimlik sunucusu çalışmıyor — yerel geliştirmede dev yığınını başlatın (packages/devstack)', en: 'identity server is down — start the dev stack locally (packages/devstack)' },
  errFlow: { tr: 'akış yarıda kesildi', en: 'the flow was interrupted' },
  tryAgain: { tr: 'Lütfen tekrar', en: 'Please' },
  tryAgainLink: { tr: 'giriş yapmayı deneyin', en: 'try signing in again' },
  fText: { tr: 'Metin', en: 'Text' },
  fWbw: { tr: 'Kelime meal & sayfa düzeni', en: 'Word-by-word & page layout' },
  fMeal: { tr: 'Meal', en: 'Translations' },
