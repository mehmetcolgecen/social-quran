...
export const DERSLER: Ders[] = [
  ...
  // ses Husary'nin tam ayet tilavetidir. İlk ayetler besmele ile başlar (mushaf kaydı).
  {
    ...
    examples: [
      ...
      { ar: 'اللَّهُ الصَّمَدُ', latin: 'allâhüs-samed', not: 'Samed: her şey O\'na muhtaç, O hiçbir şeye muhtaç değil', ayet: '112:2' },
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'الَّذِي أَطْعَمَهُم مِّن جُوعٍ وَآمَنَهُم مِّنْ خَوْفٍ', latin: 'ellezî at\'amehüm-min cûiv-ve âmenehüm-min havf', not: 'idgam (hüm-min) + ihfa (min cû) + izhar (min havf) tek ayette', ayet: '106:4' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'الَّذِينَ هُمْ عَن صَلَاتِهِمْ سَاهُونَ', latin: 'ellezîne hüm an salâtihim sâhûn', not: 'نْ + ص ihfa', ayet: '107:5' },
      { ar: 'الَّذِينَ هُمْ يُرَاءُونَ', latin: 'ellezîne hüm yürâûn', not: 'muttasıl med (yürâââûn)', ayet: '107:6' },
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ', latin: 'ellezî yüvesvisü fî sudûrin-nâs', not: 'fısıltıyı taklit eden ses dokusu', ayet: '114:5' },
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'الَّذِي أَنقَضَ ظَهْرَكَ', latin: 'ellezî enkada zahrek', not: 'نْ + ق ihfa (enkada) + kalın zı', ayet: '94:3' },
