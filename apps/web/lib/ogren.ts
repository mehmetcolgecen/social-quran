...
export const DERSLER: Ders[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'كُتِبَ', latin: 'ku-ti-be', not: 'yazıldı (2:183)' },
      { ar: 'عَمِلَ', latin: 'a-mi-le', not: 'yaptı' },
      { ar: 'حَسَدَ', latin: 'ha-se-de', not: '(113:5)' },
      { ar: 'نَصَرَ', latin: 'na-sa-ra', not: 'yardım etti' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'اَنْعَمْتَ', latin: 'en-am-te', not: 'iki sakin harf (1:7)' },
      { ar: 'رَبُّكُمْ', latin: 'rab-bu-kum', not: 'şedde + sonda sakin mim' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'غَفُورٌ', latin: 'ğafûrun', not: 'iki ötre' },
      { ar: 'رَحِيمًا', latin: 'rahîmen', not: 'iki üstün (4:100)' },
      { ar: 'شَيْءٍ', latin: "şey'in", not: 'iki esre' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'صِرَاطَ', latin: 'sırâta', not: 'kalın harf + med (1:6)' },
      { ar: 'مَٰلِكِ', latin: 'mâliki', not: 'hançer elif de uzatır (1:4)' },
      { ar: 'يُوسُفَ', latin: 'yûsufe', not: 'vav meddi (12:4)' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'اَلْكِتَٰبُ', latin: 'el-kitâbu', not: 'kamerî (2:2)' },
      { ar: 'اَلسَّمَآءِ', latin: 'es-semâi', not: 'şemsî (2:19)' },
      { ar: 'اَلدِّينِ', latin: 'ed-dîni', not: 'şemsî (1:4)' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'يَشَآءُ', latin: 'yeşâââu', not: 'muttasıl (2:90)' },
      { ar: 'اِنَّآ اَعْطَيْنَٰكَ', latin: "innâ a'taynâke", not: 'munfasıl (108:1)' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'اَنْعَمْتَ', latin: 'en-amte', not: 'izhar — ayn boğaz harfi (1:7)' },
      { ar: 'غَفُورٌ رَحِيمٌ', latin: 'ğafûrur-rahîm', not: 'tenvinde idgam (ر)' },
      { ar: 'سَمِيعٌ عَلِيمٌ', latin: 'semîun alîm', not: 'tenvinde izhar (2:181)' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'عَمَّ', latin: 'ammme', not: 'idgamlı ğunne (78:1)' },
      { ar: 'اِنَّهُمْ', latin: 'innehum', not: 'ğunne + sakin mim' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'قَدْ', latin: 'kad(ı)', not: 'dal kalkalesi' },
      { ar: 'خَلَقْنَا', latin: 'halak(ı)nâ', not: 'kaf kalkalesi (23:12)' },
      { ar: 'وَتَبَّ', latin: 'vetebb(e)', not: 'vakıfta be kalkalesi (111:1)' },
    ],
