...
export const DERSLER: Ders[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ', latin: 'bismillâhir-rahmânir-rahîm', not: 'besmele — Fatiha\'nın 1. ayeti', ayet: '1:1' },
  ...
  // ---------------- BÖLÜM 7: PRATİK ----------------
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ', latin: 'bismillâhir-rahmânir-rahîm', not: 'şemsî lam + hançer elif + med', ayet: '1:1' },
      { ar: 'اَلْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ', latin: 'elhamdü lillâhi rabbil-âlemîn', not: 'kamerî lam + şedde + ârız med', ayet: '1:2' },
      { ar: 'اَلرَّحْمَٰنِ الرَّحِيمِ', latin: 'er-rahmânir-rahîm', not: 'şemsî lamlar', ayet: '1:3' },
      { ar: 'مَالِكِ يَوْمِ الدِّينِ', latin: 'mâliki yevmid-dîn', not: 'hançer elif + lîn vavı + şemsî lam', ayet: '1:4' },
      { ar: 'إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ', latin: 'iyyâke na’büdü ve iyyâke nestaîn', not: 'şeddeli ye + ayn + ârız med', ayet: '1:5' },
      { ar: 'اِهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ', latin: 'ihdinas-sırâtal-müstakîm', not: 'şemsî + kalın sad-tı + kamerî', ayet: '1:6' },
      { ar: 'صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ', latin: '…veleddâllîn', not: 'izhar (نْ+ع) + medd-i lâzım ile bitiş', ayet: '1:7' },
    ],
  ...
  // ses Husary'nin tam ayet tilavetidir. İlk ayetler besmele ile başlar (mushaf kaydı).
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ قُلْ هُوَ اللَّهُ أَحَدٌ', latin: 'bismillâhir-rahmânir-rahîm · kul hüvellâhü ehad', not: 'De ki: O Allah birdir — kalın Allah lafzı', ayet: '112:1' },
      { ar: 'اَللَّهُ الصَّمَدُ', latin: 'allâhüs-samed', not: 'Samed: her şey O\'na muhtaç, O hiçbir şeye muhtaç değil', ayet: '112:2' },
      { ar: 'لَمْ يَلِدْ وَلَمْ يُولَدْ', latin: 'lem yelid ve lem yûled', not: 'dal\'larda vakıf kalkalesi', ayet: '112:3' },
      { ar: 'وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ', latin: 'velem yekül-lehû küfüven ehad', not: 'نْ + ل ğunnesiz idgam + izhar (tenvin+hemze)', ayet: '112:4' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ إِنَّا أَعْطَيْنَاكَ الْكَوْثَرَ', latin: 'bismillâhir-rahmânir-rahîm · innâ a\'taynâkel-kevser', not: 'şeddeli nun ğunnesi + munfasıl med', ayet: '108:1' },
      { ar: 'فَصَلِّ لِرَبِّكَ وَانْحَرْ', latin: 'fesalli li-rabbike venhar', not: 'نْ + ح izhar (venhar)', ayet: '108:2' },
      { ar: 'إِنَّ شَانِئَكَ هُوَ الْأَبْتَرُ', latin: 'inne şânieke hüvel-ebter', not: 'vakıfta ebter — ra öncesi cezmli te', ayet: '108:3' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ وَالْعَصْرِ', latin: 'bismillâhir-rahmânir-rahîm · vel-asr', not: 'kamerî lam + vakıfta ince ra', ayet: '103:1' },
      { ar: 'إِنَّ الْإِنسَانَ لَفِي خُسْرٍ', latin: 'innel-insâne lefî husr', not: 'ğunne + نْ + س ihfa (insân)', ayet: '103:2' },
      { ar: 'إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ وَتَوَاصَوْا بِالْحَقِّ وَتَوَاصَوْا بِالصَّبْرِ', latin: 'illellezîne âmenû ve amilüs-sâlihâti ve tevâsav bil-hakkı ve tevâsav bis-sabr', not: 'uzun ayette nefes planı: tevâsav\'lardan önce durabilirsiniz', ayet: '103:3' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ أَلَمْ تَرَ كَيْفَ فَعَلَ رَبُّكَ بِأَصْحَابِ الْفِيلِ', latin: 'bismillâhir-rahmânir-rahîm · elem tera keyfe feale rabbüke bi-ashâbil-fîl', not: 'lîn yesi (keyfe) + mim izharı (elem tera)', ayet: '105:1' },
      { ar: 'أَلَمْ يَجْعَلْ كَيْدَهُمْ فِي تَضْلِيلٍ', latin: 'elem yec\'al keydehüm fî tadlîl', not: 'cim kalkalesi (yec\'al)', ayet: '105:2' },
      ...
      { ar: 'فَجَعَلَهُمْ كَعَصْفٍ مَّأْكُولٍ', latin: 'fe-cealehüm ke-asfim-me\'kûl', not: 'tenvin + م ğunneli idgam', ayet: '105:5' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ لِإِيلَافِ قُرَيْشٍ', latin: 'bismillâhir-rahmânir-rahîm · li-îlâfi kurayş', not: 'kalın kaf + vakıfta şın', ayet: '106:1' },
      { ar: 'إِيلَافِهِمْ رِحْلَةَ الشِّتَاءِ وَالصَّيْفِ', latin: 'îlâfihim rihleteş-şitâi ves-sayf', not: 'şemsî lamlar + muttasıl med (şitââi)', ayet: '106:2' },
      { ar: 'فَلْيَعْبُدُوا رَبَّ هَٰذَا الْبَيْتِ', latin: 'fel-ya\'büdû rabbe hâzel-beyt', not: 'hançer elif (hâzâ) + lîn (beyt)', ayet: '106:3' },
      { ar: 'اَلَّذِي أَطْعَمَهُم مِّن جُوعٍ وَآمَنَهُم مِّنْ خَوْفٍ', latin: 'ellezî at\'amehüm-min cûiv-ve âmenehüm-min havf', not: 'idgam (hüm-min) + ihfa (min cû) + izhar (min havf) tek ayette', ayet: '106:4' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ أَرَأَيْتَ الَّذِي يُكَذِّبُ بِالدِّينِ', latin: 'bismillâhir-rahmânir-rahîm · eraeytellezî yükezzibü bid-dîn', not: 'şeddeli zel + şemsî dal', ayet: '107:1' },
      { ar: 'فَذَٰلِكَ الَّذِي يَدُعُّ الْيَتِيمَ', latin: 'fe-zâlikellezî yedu\'ul-yetîm', not: 'şeddeli ayn — yedu\'u', ayet: '107:2' },
      { ar: 'وَلَا يَحُضُّ عَلَىٰ طَعَامِ الْمِسْكِينِ', latin: 've lâ yehuddu alâ taâmil-miskîn', not: 'şeddeli kalın dad', ayet: '107:3' },
      { ar: 'فَوَيْلٌ لِّلْمُصَلِّينَ', latin: 'fe-veylül-lil-musallîn', not: 'tenvin + ل ğunnesiz idgam', ayet: '107:4' },
      { ar: 'اَلَّذِينَ هُمْ عَن صَلَاتِهِمْ سَاهُونَ', latin: 'ellezîne hüm an salâtihim sâhûn', not: 'نْ + ص ihfa', ayet: '107:5' },
      { ar: 'اَلَّذِينَ هُمْ يُرَاءُونَ', latin: 'ellezîne hüm yürâûn', not: 'muttasıl med (yürâââûn)', ayet: '107:6' },
      { ar: 'وَيَمْنَعُونَ الْمَاعُونَ', latin: 've yemneûnel-mâûn', not: 'mâûn: en küçük yardım eşyası', ayet: '107:7' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ قُلْ يَا أَيُّهَا الْكَافِرُونَ', latin: 'bismillâhir-rahmânir-rahîm · kul yâ eyyühel-kâfirûn', not: 'nida uzatması: yâââ eyyühâ', ayet: '109:1' },
      { ar: 'لَا أَعْبُدُ مَا تَعْبُدُونَ', latin: 'lâ a\'büdü mâ ta\'büdûn', not: 'munfasıl med (lâââ a\'büdü)', ayet: '109:2' },
      { ar: 'وَلَا أَنتُمْ عَابِدُونَ مَا أَعْبُدُ', latin: 've lâ entüm âbidûne mâ a\'büd', not: 'نْ + ت ihfa (entüm)', ayet: '109:3' },
      { ar: 'وَلَا أَنَا عَابِدٌ مَّا عَبَدتُّمْ', latin: 've lâ ene âbidüm-mâ abettüm', not: 'tenvin + م idgam; دتّ → "abettüm"', ayet: '109:4' },
      { ar: 'وَلَا أَنتُمْ عَابِدُونَ مَا أَعْبُدُ', latin: 've lâ entüm âbidûne mâ a\'büd', not: 'tekrar ayeti — pekiştirme', ayet: '109:5' },
      { ar: 'لَكُمْ دِينُكُمْ وَلِيَ دِينِ', latin: 'leküm dînüküm ve liye dîn', not: 'mim izharı + vakıfta dîn', ayet: '109:6' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ إِذَا جَاءَ نَصْرُ اللَّهِ وَالْفَتْحُ', latin: 'bismillâhir-rahmânir-rahîm · izâ câe nasrullâhi vel-feth', not: 'muttasıl med (câââe) + kalın Allah lafzı', ayet: '110:1' },
      { ar: 'وَرَأَيْتَ النَّاسَ يَدْخُلُونَ فِي دِينِ اللَّهِ أَفْوَاجًا', latin: 've raeyten-nâse yedhulûne fî dînillâhi efvâcâ', not: 'ince Allah lafzı (dînillâh) — esreden sonra', ayet: '110:2' },
      { ar: 'فَسَبِّحْ بِحَمْدِ رَبِّكَ وَاسْتَغْفِرْهُ ۚ إِنَّهُ كَانَ تَوَّابًا', latin: 'fe-sebbih bi-hamdi rabbike vestağfirh innehû kâne tevvâbâ', not: 'zamir sılası (innehû) + vakıfta tevvâbâ', ayet: '110:3' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ تَبَّتْ يَدَا أَبِي لَهَبٍ وَتَبَّ', latin: 'bismillâhir-rahmânir-rahîm · tebbet yedâ ebî lehebiv-ve tebb', not: 'tenvin + و idgam + vakıfta şeddeli be kalkalesi', ayet: '111:1' },
      { ar: 'مَا أَغْنَىٰ عَنْهُ مَالُهُ وَمَا كَسَبَ', latin: 'mâ ağnâ anhü mâlühû ve mâ keseb', not: 'نْ + ه izhar (anhü) + sıla (mâlühû)', ayet: '111:2' },
      { ar: 'سَيَصْلَىٰ نَارًا ذَاتَ لَهَبٍ', latin: 'se-yaslâ nâran zâte leheb', not: 'tenvin + ذ ihfa (nâran zâte)', ayet: '111:3' },
      { ar: 'وَامْرَأَتُهُ حَمَّالَةَ الْحَطَبِ', latin: 'vemraetühû hammâletel-hatab', not: 'şeddeli mim ğunnesi (hammâle)', ayet: '111:4' },
      { ar: 'فِي جِيدِهَا حَبْلٌ مِّن مَّسَدٍ', latin: 'fî cîdihâ hablüm-mim-mesed', not: 'çifte idgam: tenvin + م ve نْ + م', ayet: '111:5' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ', latin: 'bismillâhir-rahmânir-rahîm · kul eûzü bi-rabbil-felak', not: 'vakıfta kaf kalkalesi (felak)', ayet: '113:1' },
      ...
      { ar: 'وَمِن شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ', latin: 've min şerrin-neffâsâti fil-ukad', not: 'şemsî nun ğunnesi (şerrin-nef…)', ayet: '113:4' },
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ قُلْ أَعُوذُ بِرَبِّ النَّاسِ', latin: 'bismillâhir-rahmânir-rahîm · kul eûzü bi-rabbin-nâs', not: 'şemsî nun + ayet sonu ârız med (nâââs)', ayet: '114:1' },
      { ar: 'مَلِكِ النَّاسِ', latin: 'melikin-nâs', not: 'insanların hükümdarı', ayet: '114:2' },
      { ar: 'إِلَٰهِ النَّاسِ', latin: 'ilâhin-nâs', not: 'hançer elif (ilâh)', ayet: '114:3' },
      { ar: 'مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ', latin: 'min şerril-vesvâsil-hannâs', not: 'ihfa + şeddeli nun ğunnesi (hannâs)', ayet: '114:4' },
      { ar: 'اَلَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ', latin: 'ellezî yüvesvisü fî sudûrin-nâs', not: 'fısıltıyı taklit eden ses dokusu', ayet: '114:5' },
      { ar: 'مِنَ الْجِنَّةِ وَالنَّاسِ', latin: 'minel-cinneti ven-nâs', not: 'cinlerden ve insanlardan', ayet: '114:6' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ إِنَّا أَنزَلْنَاهُ فِي لَيْلَةِ الْقَدْرِ', latin: 'bismillâhir-rahmânir-rahîm · innâ enzelnâhü fî leyletil-kadr', not: 'نْ + ز ihfa (enzelnâ) + vakıfta ra: öncesi cezmli dal', ayet: '97:1' },
      { ar: 'وَمَا أَدْرَاكَ مَا لَيْلَةُ الْقَدْرِ', latin: 've mâ edrâke mâ leyletül-kadr', not: 'munfasıl med (mâ edrâke)', ayet: '97:2' },
      { ar: 'لَيْلَةُ الْقَدْرِ خَيْرٌ مِّنْ أَلْفِ شَهْرٍ', latin: 'leyletül-kadri hayrum-min elfi şehr', not: 'tenvin + م idgam + نْ + hemze izhar', ayet: '97:3' },
      { ar: 'تَنَزَّلُ الْمَلَائِكَةُ وَالرُّوحُ فِيهَا بِإِذْنِ رَبِّهِم مِّن كُلِّ أَمْرٍ', latin: 'tenezzelül-melâiketü ver-rûhu fîhâ bi-izni rabbihim-min külli emr', not: 'lâzım med (melâââike) + mim idgamı', ayet: '97:4' },
      { ar: 'سَلَامٌ هِيَ حَتَّىٰ مَطْلَعِ الْفَجْرِ', latin: 'selâmün hiye hattâ matleil-fecr', not: 'tenvin + ه izhar + esreli ince ra (fecr)', ayet: '97:5' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ وَالتِّينِ وَالزَّيْتُونِ', latin: 'bismillâhir-rahmânir-rahîm · vet-tîni vez-zeytûn', not: 'şemsî te ve ze + lîn (zeytûn)', ayet: '95:1' },
      { ar: 'وَطُورِ سِينِينَ', latin: 've tûri sînîn', not: 'kalın tı + uzun î\'ler', ayet: '95:2' },
      { ar: 'وَهَٰذَا الْبَلَدِ الْأَمِينِ', latin: 've hâzel-beledil-emîn', not: 'hançer elif + kamerî lamlar', ayet: '95:3' },
      { ar: 'لَقَدْ خَلَقْنَا الْإِنسَانَ فِي أَحْسَنِ تَقْوِيمٍ', latin: 'lekad halaknel-insâne fî ahseni takvîm', not: 'kelime içi kaf kalkalesi (halaknâ)', ayet: '95:4' },
      { ar: 'ثُمَّ رَدَدْنَاهُ أَسْفَلَ سَافِلِينَ', latin: 'sümme radednâhü esfele sâfilîn', not: 'şeddeli mim ğunnesi (sümme)', ayet: '95:5' },
      { ar: 'إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ فَلَهُمْ أَجْرٌ غَيْرُ مَمْنُونٍ', latin: 'illellezîne âmenû ve amilüs-sâlihâti fe-lehüm ecrun ğayru memnûn', not: 'tenvin + غ izhar (ecrun ğayru)', ayet: '95:6' },
      { ar: 'فَمَا يُكَذِّبُكَ بَعْدُ بِالدِّينِ', latin: 'fe-mâ yükezzibüke ba\'dü bid-dîn', not: 'şeddeli zel + şemsî dal', ayet: '95:7' },
      { ar: 'أَلَيْسَ اللَّهُ بِأَحْكَمِ الْحَاكِمِينَ', latin: 'eleysallâhü bi-ahkemil-hâkimîn', not: 'üstünden sonra kalın Allah lafzı', ayet: '95:8' },
    ],
  ...
  },
  {
    ...
    examples: [
      { ar: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ أَلَمْ نَشْرَحْ لَكَ صَدْرَكَ', latin: 'bismillâhir-rahmânir-rahîm · elem neşrah leke sadrek', not: 'mim izharı (elem neşrah) + vakıfta kef sakin', ayet: '94:1' },
      { ar: 'وَوَضَعْنَا عَنكَ وِزْرَكَ', latin: 've vada\'nâ anke vizrek', not: 'نْ + ك ihfa (anke)', ayet: '94:2' },
      { ar: 'اَلَّذِي أَنقَضَ ظَهْرَكَ', latin: 'ellezî enkada zahrek', not: 'نْ + ق ihfa (enkada) + kalın zı', ayet: '94:3' },
      { ar: 'وَرَفَعْنَا لَكَ ذِكْرَكَ', latin: 've rafa\'nâ leke zikrek', not: 'ayn sakin — boğazdan kapatın', ayet: '94:4' },
      { ar: 'فَإِنَّ مَعَ الْعُسْرِ يُسْرًا', latin: 'fe-inne meal-usri yüsrâ', not: 'ğunne + vakıfta yüsrâ (tenvin â olur)', ayet: '94:5' },
      { ar: 'إِنَّ مَعَ الْعُسْرِ يُسْرًا', latin: 'inne meal-usri yüsrâ', not: 'müjdenin tekrarı — bir zorluğa iki kolaylık', ayet: '94:6' },
      { ar: 'فَإِذَا فَرَغْتَ فَانصَبْ', latin: 'fe-izâ ferağte fensab', not: 'نْ + ص ihfa (fensab) + vakıfta be kalkalesi', ayet: '94:7' },
      { ar: 'وَإِلَىٰ رَبِّكَ فَارْغَب', latin: 've ilâ rabbike ferğab', not: 'vakıfta be kalkalesi (ferğab)', ayet: '94:8' },
    ],
