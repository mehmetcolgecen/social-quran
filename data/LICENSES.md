...
| İmlâî Arapça metin (ayet + kelime, `text_imlaei`) — Türkiye imlası görüntüleme varsayılanı | quran.com API v4 (`fields=text_imlaei`, `word_fields=text_imlaei`) | quran.com üzerinden açık sunulur | Kanonik metin Tanzil Uthmani olarak kalır; imlâî yalnız görüntülemedir |
